...
const VisaSection = ({ currentLocale }: HeroProps) => {
  ...
  const visaRequirements: Record<CountryTab, VisaRequirement> = {
    gambia: {
      title: getTranslation(currentLocale, 'visa.gambia_title'),
      flag: "🇬🇲",
      visaFree: [
    ...
    senegal: {
      title: getTranslation(currentLocale, 'visa.senegal_title'),
      flag: "🇸🇳",
      visaFree: [
  ...
  const supportDocuments: SupportDocument[] = [
    {
      ...
      title: getTranslation(currentLocale, 'visa.support_document_1_title'),
      description: getTranslation(currentLocale, 'visa.support_document_1_description'),
      action: getTranslation(currentLocale, 'visa.support_document_1_action')
    },
    {
      icon: <CheckCircle className="w-6 h-6" />,
      title: getTranslation(currentLocale, 'visa.support_document_2_title'),
      description: getTranslation(currentLocale, 'visa.support_document_2_description'),
      action: getTranslation(currentLocale, 'visa.support_document_2_action')
    },
    {
      icon: <Globe className="w-6 h-6" />,
      title: getTranslation(currentLocale, 'visa.support_document_3_title'),
      description: getTranslation(currentLocale, 'visa.support_document_3_description'),
      action: getTranslation(currentLocale, 'visa.support_document_3_action')
    },
    {
      icon: <Plane className="w-6 h-6" />,
      title: getTranslation(currentLocale, 'visa.support_document_4_title'),
      description: getTranslation(currentLocale, 'visa.support_document_4_description'),
      action: getTranslation(currentLocale, 'visa.support_document_4_action')
    }
  ];
  ...
  const processSteps: ProcessStep[] = [
    {
      step: "1",
      title: getTranslation(currentLocale, 'visa.process_step_1_title'),
      description: getTranslation(currentLocale, 'visa.process_step_1_description')
    },
    {
      step: "2",
      title: getTranslation(currentLocale, 'visa.process_step_2_title'),
      description: getTranslation(currentLocale, 'visa.process_step_2_description')
    },
    {
      step: "3",
      title: getTranslation(currentLocale, 'visa.process_step_3_title'),
      description: getTranslation(currentLocale, 'visa.process_step_3_description')
    },
    {
      step: "4",
      title: getTranslation(currentLocale, 'visa.process_step_4_title'),
      description: getTranslation(currentLocale, 'visa.process_step_4_description')
    },
    {
      step: "5",
      title: getTranslation(currentLocale, 'visa.process_step_5_title'),
      description: getTranslation(currentLocale, 'visa.process_step_5_description')
    }
  ];
    ...
    <section className="relative py-24 bg-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-3xl p-8 border border-slate-200 shadow-lg">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="bg-green-50 rounded-2xl p-6 border border-green-200">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-2xl font-bold text-green-800">{getTranslation(currentLocale, 'visa.visa_free_entry')}</h4>
                </div>
                <p className="text-green-700 mb-4 font-medium">{getTranslation(currentLocale, 'visa.visa_free_text')}</p>
              ...
              <div className="bg-yellow-50 rounded-2xl p-6 border border-yellow-200">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-2xl font-bold text-yellow-800">{getTranslation(currentLocale, 'visa.visa_on_arrival')}</h4>
                </div>
                <p className="text-yellow-700 mb-4 font-medium">{getTranslation(currentLocale, 'visa.visa_on_arrival_text')}</p>
                <div className="flex flex-wrap gap-2">
            ...
            <div className="mt-8 bg-slate-800 rounded-2xl p-6 text-white">
              <h4 className="text-xl font-bold mb-4 flex items-center">
                ...
                {getTranslation(currentLocale, 'visa.embassy_contact')}
              </h4>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h3 className="text-4xl font-bold text-slate-800 mb-4">
              {getTranslation(currentLocale, 'visa.support_documents_title')}
            </h3>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              {getTranslation(currentLocale, 'visa.support_documents_text')}
            </p>
          </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h3 className="text-4xl font-bold text-slate-800 mb-4">
              {getTranslation(currentLocale, 'visa.application_process_title')}
            </h3>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              {getTranslation(currentLocale, 'visa.application_process_text')}
            </p>
          </div>
        ...
        <div className="bg-gradient-to-r from-slate-800 to-slate-900 rounded-3xl p-8 text-center shadow-2xl">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-center mb-6">
              ...
              <h3 className="text-3xl font-bold text-white">{getTranslation(currentLocale, 'visa.important_notice_title')}</h3>
            </div>
            <p className="text-xl text-slate-300 mb-8 leading-relaxed">
              {getTranslation(currentLocale, 'visa.important_notice_text')}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="group bg-gradient-to-r from-yellow-500 to-yellow-600 text-slate-900 px-8 py-4 rounded-2xl text-lg font-bold hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
                {getTranslation(currentLocale, 'visa.request_visa_support')}
              ...
              <button className="bg-transparent border-2 border-yellow-400 text-yellow-400 px-8 py-4 rounded-2xl text-lg font-bold hover:bg-yellow-400 hover:text-slate-900 transition-all duration-300">
                {getTranslation(currentLocale, 'visa.contact_visa_team')}
              </button>
            </div>

            <div className="mt-8 text-slate-400">
              <span className="text-yellow-400">✈️</span> {getTranslation(currentLocale, 'visa.safe_travels')} <span className="text-yellow-400">🇬🇲🇸🇳</span>
            </div>
          </div>
        </div>
      </div>
