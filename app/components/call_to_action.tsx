      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-yellow-100 to-yellow-200 border border-yellow-300 mb-6">
            ...
            <span className="text-sm font-semibold text-yellow-800">Limited Time Opportunity</span>
          </div>
          
          <h2 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
            <span className="text-slate-800">Dont Miss Out on</span>
            <br />
          ...
          <p className="text-xl md:text-2xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
            Be part of the inaugural PyCon Senegambia and help shape the future of Python development in Senegambia
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          <div className="group text-center bg-gradient-to-br from-slate-50 to-slate-100 rounded-3xl p-8 hover:shadow-2xl transition-all duration-500 border border-slate-200 hover:border-yellow-300">
            ...
            <h3 className="text-2xl font-bold text-slate-800 mb-3">Network with Peers</h3>
            <p className="text-slate-600 leading-relaxed">Connect with 500+ Python developers from across the Senegambia region and build lasting professional relationships</p>
          </div>
          ...
          <div className="group text-center bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-3xl p-8 hover:shadow-2xl transition-all duration-500 border border-yellow-200 hover:border-yellow-400">
            ...
            <h3 className="text-2xl font-bold text-slate-800 mb-3">Learn & Grow</h3>
            <p className="text-slate-600 leading-relaxed">Attend cutting-edge workshops, inspiring talks, and hands-on sessions led by industry experts and thought leaders</p>
          </div>
          ...
          <div className="group text-center bg-gradient-to-br from-slate-50 to-slate-100 rounded-3xl p-8 hover:shadow-2xl transition-all duration-500 border border-slate-200 hover:border-yellow-300">
            ...
            <h3 className="text-2xl font-bold text-slate-800 mb-3">Build Community</h3>
            <p className="text-slate-600 leading-relaxed">Help establish a thriving Python ecosystem that bridges Gambia and Senegal, fostering innovation across borders</p>
          </div>
        </div>
        ...
        <div className="relative max-w-5xl mx-auto mb-16">
          ...
          <div className="relative bg-white border-2 border-yellow-400 rounded-3xl p-10 shadow-2xl">
            <div className="text-center mb-8">
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4">Limited Time Offer</h3>
              <p className="text-xl text-slate-600">Secure your spot at the most anticipated tech event in Senegambia</p>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-12">
              ...
              <div className="flex items-center bg-slate-100 rounded-2xl px-8 py-6 border border-slate-200">
                ...
                <div>
                  <div className="text-slate-800 font-bold text-lg">Offer expires</div>
                  <div className="text-yellow-600 font-semibold text-2xl">September 30, 2025</div>
                </div>
              </div>
            </div>
          </div>
